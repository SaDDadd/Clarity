...
class ProjectRepository:
    ...
    @log
    def get_projects_by_admin(self, admin_id: int) -> list[Project]: # Получить все проекты админа
    ...
    @log
    def update_project_description(self, new_description: str, project_id: int) -> int | None: # Обновить описание проекта
    ...
    def is_user_in_project(self, project_id: int, user_id: int) -> bool: # Проверить, состоит ли пользователь в проекте
    ...
    @log
    def create_project_with_admin(self, name: str, description: str, admin_id: int, role: str) -> list[int] | None: # Создать проект и добавить админа
    ...
    @log
    def get_user_role_in_project(self, project_id: int, user_id: int) -> str | None: # Получить роль пользователя в проекте
