...
> **В разработке:** приглашения в проекты, чат проекта, уведомления, фильтрация задач, процент готовности проекта, контейнеризация (Docker), логирование и юнит-тесты.
...
- [ ] **Приглашения в проекты** – администратор приглашает пользователей, те принимают/отклоняют, автоматическое добавление.
