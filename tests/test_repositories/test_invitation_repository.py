...
class TestProjectInvitationRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_invitation_by_user_success(self, db_session: AsyncSession, test_invitation, test_users):
        repo = ProjectInvitationRepository(db_session)
        invitee = test_users['outsider']
    ...
    @pytest.mark.asyncio
    async def test_get_invitation_for_project_success(self, db_session: AsyncSession, test_invitation, test_project):
        repo = ProjectInvitationRepository(db_session)
